...
from converters import add_trailing_zeros, parse_coordinate
...
CEMETERY_MAPPING = {
    ...
    'nykyiset_kunnat': {'uri': SCHEMA_NS.municipality,
                        'name_fi': 'Kunta',
    ...
    'kuva_2_yksittäinen_hauta_risteineen_muistolaattoineen': {'uri': SCHEMA_NS.photograp_2,
                                                              'name_fi': 'Valokuva 2',
    ...
    'kuva_4_yleiskuva': {'uri': SCHEMA_NS.photograp_4,
                                                'name_fi': 'Valokuva 4',
                                                'name_en': 'Photograph 4'},
    'kuva_4_kuvaajan_nimi': {'uri': SCHEMA_NS.photographer_4,
                             'name_fi': 'Kuvaaja 4',
                             'name_en': 'Photographer 4'},
    'kuva_5_ muu_muistomerkki': {'uri': SCHEMA_NS.photograp_5,
                                 'name_fi': 'Valokuva 5',
                                 'name_en': 'Photograph 5'},
    'kuva_5_kuvaajan_nimi': {'uri': SCHEMA_NS.photographer_4,
                             'name_fi': 'Kuvaaja 5',
